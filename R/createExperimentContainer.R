...
#' @param body values for sample attributes as a  list of key-values pairs (not user in this version)
...
#' item<-CoreAPIV2::createExperimentContainer(login$coreApi,"Experiment_Type","ExperimentBarCode","Containerbarcode")
