...
#' item<-CoreAPIV2::updateEntityAssociations(login$coreApi,"entityType","barcode",values)
...
updateEntityAssociations<-function (coreApi,entityType,barcode,updateValues,useVerbose=FALSE)
