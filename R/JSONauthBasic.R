#'JSONauthBasic - Authenticates against the LIMS using basic authentication.
#'
...
JSONauthBasic<-function(coreApi,useVerbose=FALSE)

{
  ...
  response<- CoreAPIV2::JSONapiCall(coreApi,request,"json",useVerbose=useVerbose,special="login")
