     ...
     test_that(paste("test login parameters for environment", instance),
            {
              ...
              b<-CoreAPIV2::getEntityByBarcode(con$coreApi,"PATIENT_SAMPLE","PS1",useVerbose=verbose)$entity
     ...
     test_that(paste("test login parameters for environment", instance),
               {
                 ...
                 b<-CoreAPIV2::getEntityByBarcode(con$coreApi,"BEER","BEER1",useVerbose=verbose)$entity
